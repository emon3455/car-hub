        ...
        <section className='p-2 my-10 w-full md:w-4/5 mx-auto'>
            ...
            <div className="max-w-3xl mx-auto">
                <Reorder.Group axis="y" values={items} onReorder={setItems}>
                    {items.map((item: any) => (
                        <Reorder.Item key={item} value={item} className="shadow-2xl bg-white p-2 w-full flex justify-around items-center gap-5 mb-5 transition-all duration-700 ease-linear">
                            <div className="">
