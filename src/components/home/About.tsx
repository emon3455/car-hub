...
const About = () => {
    return (
        <section id='about' className='w-full md:w-4/5 mx-auto my-20 p-2 grid grid-cols-1 md:grid-cols-2 items-center gap-10'>
            <div className="">
                <p className='border-l-4 border-red-500 font-semibold my-4 pl-2'> About Us</p>
